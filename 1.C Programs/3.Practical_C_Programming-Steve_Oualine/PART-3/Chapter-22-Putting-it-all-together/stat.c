...
/********************************************************
 * lc_taken_token -- Consumes tokens and looks for
 * 			end-of-line tokens.
 *
 * Parameters
...
/********************************************************
 * comment_counter -- Counts the number of lines with 
 * 		and without comments.
 *
 * Outputs nothing at the beginning of each line, but
 * will output a ration at the end of file.
 *
 ...
 * important.
 * ******************************************************/ 
static const int CF_COMMENT = (1<<0);	// Line contains comments
static const int CF_CODE  = (1<<1);	// Line contains code
// These bits are combined to form the statistics

//	0			-- [0] Blank line
//	CF_COMMENT		-- [1] Comment_only line
//	CF_CODE			-- [2] Code-only line
//	CF_COMMENT|CF_CODE	-- [3] Comments and code ont this line
