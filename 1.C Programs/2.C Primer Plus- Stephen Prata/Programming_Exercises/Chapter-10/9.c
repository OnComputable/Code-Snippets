...
void copy_2dim_arr(int rows, int cols, double source[rows][cols], double target[rows][cols])
{
	// copy one two_dimentional array to another
...
void print_2dim_arr(int rows, int cols, double arr[rows][cols])
{
	// print the contents of a two-dimentional array
...
int main(void)
{
	double array1[ROWS][COLUMNS] = {{4.3, 5.7, 2.1, 6.6, .8}, {5.6, 23.5, 73.2, 12.3, 123}, {22.1, 35.3, 6.35, 0.132, 11.1}};
