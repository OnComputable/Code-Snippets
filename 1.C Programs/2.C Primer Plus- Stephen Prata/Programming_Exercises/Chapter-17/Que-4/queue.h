...
// opearation:	check if queue is full
...
// 		 rear of queue and function returns True;
// 		 otherwise, queue is unchanged function returns 
// 		 False
...
// 		 queue, and function returns True; if the operation
// 		 empties the queue, the queue is reset to empty, If the queue is 
// 		 empty to begin with, queue is unchanged and the function
// 		 returns False
bool DeQueue(Item *pitem, Queue * pq);

// opearion:	empty the queue
