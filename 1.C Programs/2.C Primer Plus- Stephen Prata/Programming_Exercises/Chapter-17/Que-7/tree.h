...
// Preconditions: ptree points to an uninitialized Tree
// Postconditions: ptree points to an uninitialized Tree
...
// the count number of that node, otherwise create a new Node
